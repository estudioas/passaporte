...
<aside class="admin-sidebar">
    ...
    <nav><a href="/admin">Visão geral</a><?php if (($user['role'] ?? '') === 'administrator'): ?><a href="/admin/finalistas">Finalistas</a><?php endif; ?><a href="/admin/auditoria">Auditoria</a><?php if (($user['role'] ?? '') === 'administrator'): ?><a href="/admin/inscricoes">Inscrições</a><a href="/admin/usuarios">Usuários</a><a href="/admin/configuracoes">Configurações</a><?php endif; ?><a href="/" target="_blank">Ver site ↗</a></nav>
