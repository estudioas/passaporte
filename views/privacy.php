<section class="hero hero-compact">
    ...
    <h1>Privacidade com dados suficientes para auditar — e nada além.</h1>
    <p>Este aviso explica o que a campanha registra, por quanto tempo e com qual finalidade.</p>
</section>
<article class="section legal-page">
    <h2>1. Controlador e finalidade</h2>
    <p>A Ruffino Acabamentos, CNPJ 24.440.377/0001-18, trata dados para administrar inscrições, validar elegibilidade, operar a votação, prevenir fraude, apurar resultados, entregar prêmios e atender obrigações legais.</p>
    ...
    <p>O titular pode solicitar confirmação, acesso, correção, informação sobre compartilhamento, oposição ou eliminação quando cabível. Antes da publicação, a Ruffino deverá informar neste aviso um canal oficial de privacidade.</p>
    <div class="notice warning"><strong>Pendência de publicação:</strong> substitua este trecho pelo e-mail do encarregado/canal LGPD da Ruffino antes de colocar o site no ar.</div>
    <h2>7. Segurança e incidentes</h2>
    <p>São usados criptografia de dados pessoais, controle de acesso administrativo, registros encadeados por hash, proteção de sessão, limites de tentativa e backups. Incidentes relevantes serão avaliados e comunicados conforme a legislação e orientações da ANPD.</p>
</article>
